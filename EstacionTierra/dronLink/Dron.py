...
class Dron(object):
    ...
    from dronLink.modules.dron_nav import _prepare_command, go, _startGo, _stopGo, _goingTread, changeHeading, \
        _changeHeading, fixHeading, unfixHeading, changeNavSpeed, _checkHeadingReached
